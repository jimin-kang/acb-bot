...
def getFun():
    ...
    '''
    msg = '''
    Gentlemen, we've had fun over the past few days but it's time to branch out now. We're throwing the first annual 
    Baseball Barbeque behind Mayo at 5:30. We have WoLax, WoHockey, and potentially WoSquash on the lineup card today so we're starting with a bang. 
    Let's start the semester right. /n/n
    P.S. Shut up Robin
    '''
    return msg
def getNews():
